...
if ($pass2==$pass3) {
    ...
    include_once("dbconnect.php");
  	$query = "INSERT INTO staff"."(id,full_name,username,password,reference)"."VALUES (NULL,'$fullname','$username2','$p','$usname')";
...
<body>
	<div class="container-fluid">
      ...
      <div class="col-sm-2" style="margin-top:40px;"><button type="button" class="btn btn-info " style="float:left;font-size:18px;" onclick="window.location='logout.php'">Logout
      </button></div>
</div>
